...
class V1CreatePromptVersionResponseTypedDict(TypedDict):
...
class V1CreatePromptVersionResponse(BaseModel):
    ...
    def serialize_model(self, handler):
        optional_fields = set(["version", "deduplicated"])
