...
class ConnectionCredentialsInputTypedDict(TypedDict):
    oauth: NotRequired[Nullable[OAuth2ClientCredentialsInputTypedDict]]
    headers: NotRequired[Nullable[Dict[str, str]]]
    bearer_token: NotRequired[Nullable[str]]


class ConnectionCredentialsInput(BaseModel):
    oauth: OptionalNullable[OAuth2ClientCredentialsInput] = UNSET
