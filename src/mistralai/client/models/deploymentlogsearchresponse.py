...
class DeploymentLogSearchResponseTypedDict(TypedDict):
    results: List[DeploymentLogRecordTypedDict]
    next_cursor: NotRequired[Nullable[str]]


class DeploymentLogSearchResponse(BaseModel):
    results: List[DeploymentLogRecord]
