...
class NoneAuthMethodTypedDict(TypedDict):
    method_type: Literal["none"]
    headers: NotRequired[Nullable[List[ConnectorAuthenticationHeaderTypedDict]]]
    r"""Headers whose values must be provided as credentials."""


class NoneAuthMethod(BaseModel):
