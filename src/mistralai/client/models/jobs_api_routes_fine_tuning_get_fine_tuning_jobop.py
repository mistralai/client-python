...
JobsAPIRoutesFineTuningGetFineTuningJobClassifierDetailedJobOutStatus = Union[
    Literal[
        "QUEUED",
        "STARTED",
        "VALIDATING",
...
class ClassifierDetailedJobOutGetFineTuningJobResponseTypedDict(TypedDict):
    id: str
    auto_start: bool
    model: str
    status: JobsAPIRoutesFineTuningGetFineTuningJobClassifierDetailedJobOutStatus
    created_at: int
    modified_at: int
...
class ClassifierDetailedJobOutGetFineTuningJobResponse(BaseModel):
    id: str
    ...
    integrations: OptionalNullable[
        List[JobsAPIRoutesFineTuningGetFineTuningJobClassifierDetailedJobOutIntegration]
    ] = UNSET
...
JobsAPIRoutesFineTuningGetFineTuningJobCompletionDetailedJobOutStatus = Union[
    Literal[
        "QUEUED",
        "STARTED",
        "VALIDATING",
...
JobsAPIRoutesFineTuningGetFineTuningJobRepository = GithubRepositoryOut


class CompletionDetailedJobOutGetFineTuningJobResponseTypedDict(TypedDict):
    id: str
    auto_start: bool
    model: str
    status: JobsAPIRoutesFineTuningGetFineTuningJobCompletionDetailedJobOutStatus
    created_at: int
    modified_at: int
    training_files: List[str]
    ...
    repositories: NotRequired[
        List[JobsAPIRoutesFineTuningGetFineTuningJobRepositoryTypedDict]
    ]
    events: NotRequired[List[EventOutTypedDict]]
    r"""Event items are created every time the status of a fine-tuning job changes. The timestamped list of all events is accessible here."""
    checkpoints: NotRequired[List[CheckpointOutTypedDict]]
...
class CompletionDetailedJobOutGetFineTuningJobResponse(BaseModel):
    id: str
    ...
    integrations: OptionalNullable[
        List[JobsAPIRoutesFineTuningGetFineTuningJobCompletionDetailedJobOutIntegration]
    ] = UNSET
    ...
    repositories: Optional[List[JobsAPIRoutesFineTuningGetFineTuningJobRepository]] = (
        None
    )
