...
ListFineTuningJobsStatus = Literal[
    "QUEUED",
    "STARTED",
    "VALIDATING",
    "VALIDATED",
...
class ListFineTuningJobsRequestTypedDict(TypedDict):
    ...
    status: NotRequired[Nullable[ListFineTuningJobsStatus]]
    r"""The current job state to filter on. When set, the other results are not displayed."""
...
class ListFineTuningJobsRequest(BaseModel):
    ...
    status: Annotated[
        OptionalNullable[ListFineTuningJobsStatus],
        FieldMetadata(query=QueryParamMetadata(style="form", explode=True)),
    ] = UNSET
    r"""The current job state to filter on. When set, the other results are not displayed."""
