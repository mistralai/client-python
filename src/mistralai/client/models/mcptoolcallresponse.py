...
MCPToolCallResponseContentTypedDict = TypeAliasType(
...
class UnknownMCPToolCallResponseContent(BaseModel):
    r"""A MCPToolCallResponseContent variant the SDK doesn't recognize. Preserves the raw payload."""
...
_MCP_TOOL_CALL_RESPONSE_CONTENT_VARIANTS: dict[str, Any] = {
    "text": TextContent,
    "image": ImageContent,
    "audio": AudioContent,
...
MCPToolCallResponseContent = Annotated[
    Union[
        TextContent,
        ImageContent,
        AudioContent,
    ...
    BeforeValidator(
        partial(
            parse_open_union,
            disc_key="type",
            variants=_MCP_TOOL_CALL_RESPONSE_CONTENT_VARIANTS,
            unknown_cls=UnknownMCPToolCallResponseContent,
            union_name="MCPToolCallResponseContent",
        )
    ),
]


class MCPToolCallResponseTypedDict(TypedDict):
    ...
    content: List[MCPToolCallResponseContentTypedDict]
    metadata: NotRequired[Nullable[MCPToolCallMetadataTypedDict]]
...
class MCPToolCallResponse(BaseModel):
    ...
    content: List[MCPToolCallResponseContent]

    metadata: OptionalNullable[MCPToolCallMetadata] = UNSET
