...
ClassifierJobIntegrationTypedDict = WandbIntegration1TypedDict


ClassifierJobIntegration = WandbIntegration1


class ClassifierJobTypedDict(TypedDict):
    id: str
    r"""The ID of the job."""
    auto_start: bool
    model: str
    ...
    integrations: NotRequired[Nullable[List[ClassifierJobIntegrationTypedDict]]]
...
class ClassifierJob(BaseModel):
    ...
    integrations: OptionalNullable[List[ClassifierJobIntegration]] = UNSET
    r"""A list of integrations enabled for your fine-tuning job."""
