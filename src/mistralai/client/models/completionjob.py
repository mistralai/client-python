...
CompletionJobIntegrationTypedDict = WandbIntegration1TypedDict


CompletionJobIntegration = WandbIntegration1


CompletionJobRepositoryTypedDict = GithubRepositoryTypedDict


CompletionJobRepository = GithubRepository


class CompletionJobTypedDict(TypedDict):
    id: str
    r"""The ID of the job."""
    auto_start: bool
    model: str
    ...
    integrations: NotRequired[Nullable[List[CompletionJobIntegrationTypedDict]]]
    ...
    repositories: NotRequired[List[CompletionJobRepositoryTypedDict]]
...
class CompletionJob(BaseModel):
    ...
    integrations: OptionalNullable[List[CompletionJobIntegration]] = UNSET
    r"""A list of integrations enabled for your fine-tuning job."""
    ...
    repositories: Optional[List[CompletionJobRepository]] = None
