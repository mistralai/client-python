...
class UnknownClassifierJobOutIntegration(BaseModel):
    r"""A ClassifierJobOutIntegration variant the SDK doesn't recognize. Preserves the raw payload."""
...
_CLASSIFIER_JOB_OUT_INTEGRATION_VARIANTS: dict[str, Any] = {
...
try:
    ClassifierJobOut.model_rebuild()
except NameError:
    pass
