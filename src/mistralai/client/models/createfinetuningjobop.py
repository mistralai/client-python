...
CreateFineTuningJobResponseTypedDict = TypeAliasType(
...
CreateFineTuningJobResponse = TypeAliasType(
    "CreateFineTuningJobResponse", Union[LegacyJobMetadataOut, Response]
)
r"""OK"""
