...
from mistralai.client.utils import get_discriminator, validate_open_enum
...
AgentsCompletionStreamRequestTool = Annotated[
    Union[
...
AgentsCompletionStreamRequestToolChoice = TypeAliasType(
    ...
    Union[
        ToolChoice, Annotated[ToolChoiceEnum, PlainValidator(validate_open_enum(False))]
    ],
)
