...
AgentsCompletionStreamRequestTools1TypedDict = TypeAliasType(
...
AgentsCompletionStreamRequestTools1 = TypeAliasType(
...
AgentsCompletionStreamRequestTools2TypedDict = TypeAliasType(
    "AgentsCompletionStreamRequestTools2TypedDict",
    Union[List[AgentsCompletionStreamRequestTools1TypedDict], List[str]],
)


AgentsCompletionStreamRequestTools2 = TypeAliasType(
    "AgentsCompletionStreamRequestTools2",
    Union[List[AgentsCompletionStreamRequestTools1], List[str]],
)
...
class AgentsCompletionStreamRequestTypedDict(TypedDict):
    ...
    tools: NotRequired[Nullable[AgentsCompletionStreamRequestTools2TypedDict]]
...
class AgentsCompletionStreamRequest(BaseModel):
    ...
    tools: OptionalNullable[AgentsCompletionStreamRequestTools2] = UNSET
