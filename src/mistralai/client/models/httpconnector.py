...
class HTTPConnectorTypedDict(TypedDict):
    id: str
    name: str
    description: str
    created_at: datetime
    ...
    blocked_by: NotRequired[List[ConsumerType]]
...
class HTTPConnector(BaseModel):
    ...
    blocked_by: Optional[List[ConsumerType]] = None
