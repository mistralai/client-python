...
AppendConversationRequestHandoffExecution = Literal[
    "client",
    "server",
]
...
class AppendConversationRequestTypedDict(TypedDict):
    ...
    handoff_execution: NotRequired[AppendConversationRequestHandoffExecution]
...
class AppendConversationRequest(BaseModel):
    ...
    handoff_execution: Optional[AppendConversationRequestHandoffExecution] = "server"
