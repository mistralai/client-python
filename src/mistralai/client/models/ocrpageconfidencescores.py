...
class OCRPageConfidenceScoresTypedDict(TypedDict):
    ...
    token_scores: NotRequired[List[OCRConfidenceScoreTypedDict]]
    r"""Token-level confidence scores (internal only)"""
...
class OCRPageConfidenceScores(BaseModel):
    ...
    token_scores: Optional[List[OCRConfidenceScore]] = None
    r"""Token-level confidence scores (internal only)"""
    ...
    def serialize_model(self, handler):
        optional_fields = set(["token_scores", "word_confidence_scores"])
