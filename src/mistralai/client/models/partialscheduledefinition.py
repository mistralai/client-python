...
class PartialScheduleDefinitionTypedDict(TypedDict):
...
class PartialScheduleDefinition(BaseModel):
    r"""Schedule definition for partial updates.
    ...
    def serialize_model(self, handler):
        ...
        nullable_fields = set(
            ["start_at", "end_at", "jitter", "time_zone_name", "max_executions"]
        )
