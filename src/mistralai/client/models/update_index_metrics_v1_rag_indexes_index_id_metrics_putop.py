...
class UpdateIndexMetricsV1RagIndexesIndexIDMetricsPutRequestTypedDict(TypedDict):
    index_id: str
    request_body: MetricsDataTypedDict


class UpdateIndexMetricsV1RagIndexesIndexIDMetricsPutRequest(BaseModel):
    index_id: Annotated[
