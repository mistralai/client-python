...
ListConversationsResponseTypedDict = TypeAliasType(
    "ListConversationsResponseTypedDict",
    Union[AgentConversationTypedDict, ModelConversationTypedDict],
)


ListConversationsResponse = TypeAliasType(
    "ListConversationsResponse", Union[AgentConversation, ModelConversation]
)
