...
InternalAgentCreationRequestToolTypedDict = TypeAliasType(
...
InternalAgentCreationRequestTool = Annotated[
    Union[
        CodeInterpreterTool,
        CustomConnector,
        DocumentLibraryTool,
...
class InternalAgentCreationRequestTypedDict(TypedDict):
    r"""Internal creation of agent. This is used from AI Studio"""
    ...
    tools: NotRequired[List[InternalAgentCreationRequestToolTypedDict]]
...
class InternalAgentCreationRequest(BaseModel):
    r"""Internal creation of agent. This is used from AI Studio"""
    ...
    tools: Optional[List[InternalAgentCreationRequestTool]] = None
    r"""List of tools which are available to the model during the conversation."""
