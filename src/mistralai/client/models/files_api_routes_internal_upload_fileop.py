...
class FilesAPIRoutesInternalUploadFileMultiPartBodyParamsTypedDict(TypedDict):
    file: FileTypedDict
...
class FilesAPIRoutesInternalUploadFileMultiPartBodyParams(BaseModel):
