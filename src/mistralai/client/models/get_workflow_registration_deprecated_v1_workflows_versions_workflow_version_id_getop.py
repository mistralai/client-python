...
class GetWorkflowRegistrationDeprecatedV1WorkflowsVersionsWorkflowVersionIDGetRequestTypedDict(
    TypedDict
):
...
class GetWorkflowRegistrationDeprecatedV1WorkflowsVersionsWorkflowVersionIDGetRequest(
    BaseModel
):
