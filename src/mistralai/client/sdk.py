...
class Mistral(BaseSDK):
    ...
    def configure_workflow_encoding(
        ...
        Args:
            config: The WorkflowEncodingConfig containing offloading and encryption settings.
            namespace: The workflow namespace (required for payload offloading).

        Returns:
            Self for method chaining.

        Raises:
            WorkflowPayloadOffloadingException: If the configuration is invalid (e.g.,
                offloading enabled without storage config, or encryption enabled without key).
        ...
        Example:
            ...
            ... )
            >>> client = Mistral(api_key="...").configure_workflow_encoding(
            ...     WorkflowEncodingConfig(
            ...         payload_encryption=PayloadEncryptionConfig(
            ...             mode=PayloadEncryptionMode.FULL,
            ...             main_key="your-hex-encoded-key",
            ...         )
            ...     ),
