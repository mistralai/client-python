...
class Models(BaseSDK):
    ...
    def update(
        ...
        *,
        ...
        request = models.JobsAPIRoutesFineTuningUpdateFineTunedModelRequest(
            model_id=model_id,
            update_ft_model_request=models.UpdateFTModelRequest(
                name=name,
        ...
        req = self._build_request(
            ...
            get_serialized_body=lambda: utils.serialize_request_body(
                request.update_ft_model_request,
                False,
                False,
                "json",
                models.UpdateFTModelRequest,
            ),
            allow_empty_value=None,
            timeout_ms=timeout_ms,
        )
    ...
    def archive(
        ...
        *,
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return unmarshal_json_response(models.ArchiveFTModelResponse, http_res)
        if utils.match_response(http_res, "4XX", "*"):
            http_res_text = utils.stream_to_text(http_res)
            raise models.SDKError("API error occurred", http_res, http_res_text)
        if utils.match_response(http_res, "5XX", "*"):
    ...
    def unarchive(
        ...
        *,
        ...
        timeout_ms: Optional[int] = None,
        http_headers: Optional[Mapping[str, str]] = None,
    ) -> models.UnarchiveFTModelResponse:
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return unmarshal_json_response(models.UnarchiveFTModelResponse, http_res)
        if utils.match_response(http_res, "4XX", "*"):
            http_res_text = utils.stream_to_text(http_res)
            raise models.SDKError("API error occurred", http_res, http_res_text)
        if utils.match_response(http_res, "5XX", "*"):
