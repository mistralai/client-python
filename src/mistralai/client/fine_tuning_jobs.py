...
from mistralai.client.models import (
    classifiertargetinput as models_classifiertargetinput,
    ...
    def create(
        ...
        *,
        ...
        classifier_targets: OptionalNullable[
            Union[
                List[models_classifiertargetinput.ClassifierTargetInput],
                List[models_classifiertargetinput.ClassifierTargetInputTypedDict],
            ]
        ] = UNSET,
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
        ...
        request = models.CreateFineTuningJobRequest(
            ...
            classifier_targets=utils.get_pydantic_model(
                classifier_targets, OptionalNullable[List[models.ClassifierTargetInput]]
            ),
        )
