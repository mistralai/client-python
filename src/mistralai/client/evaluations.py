...
class Evaluations(BaseSDK):
    ...
    async def list_pipeline_configs_async(
        self,
        *,
        pipeline_kind: OptionalNullable[models.PipelineKind] = UNSET,
        group: OptionalNullable[str] = UNSET,
    ...
    async def get_pipeline_config_async(
        self,
        *,
        pipeline_config_id: str,
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
    ...
    async def update_pipeline_config_async(
        self,
        *,
        pipeline_config_id: str,
        pipeline_kind: models.PipelineKind,
    ...
    async def delete_pipeline_config_async(
        self,
        *,
        pipeline_config_id: str,
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
