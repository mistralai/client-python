...
class Libraries(BaseSDK):
    ...
    def create(
        ...
        *,
        ...
        crawler_config: OptionalNullable[
            Union[models.LibraryCrawlerInput, models.LibraryCrawlerInputTypedDict]
        ] = UNSET,
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
        timeout_ms: Optional[int] = None,
        ...
        request = models.LibraryIn(
            ...
            crawler_config=utils.get_pydantic_model(
                crawler_config, OptionalNullable[models.LibraryCrawlerInput]
            ),
        )
    ...
    def libraries_resync_v1(
        ...
        *,
        ...
        request = models.LibrariesResyncV1Request(
            library_id=library_id,
        )

        req = self._build_request(
            method="POST",
            path="/v1/libraries/{library_id}/resync",
            base_url=base_url,
            url_variables=url_variables,
            request=request,
            request_body_required=False,
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(
                config=self.sdk_configuration,
                base_url=base_url or "",
                operation_id="libraries_resync_v1",
                oauth2_scopes=None,
                security_source=get_security_from_env(
                    self.sdk_configuration.security, models.Security
                ),
    ...
    async def libraries_resync_v1_async(
        self,
        *,
        library_id: str,
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
    ...
    def libraries_cancel_sync_v1(
        ...
        *,
        ...
        r"""Cancel the library sync if it is running.
        ...
        request = models.LibrariesCancelSyncV1Request(
            library_id=library_id,
        )

        req = self._build_request(
            method="POST",
            path="/v1/libraries/{library_id}/cancel_sync",
            base_url=base_url,
            url_variables=url_variables,
            request=request,
            request_body_required=False,
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(
                config=self.sdk_configuration,
                base_url=base_url or "",
                operation_id="libraries_cancel_sync_v1",
                oauth2_scopes=None,
                security_source=get_security_from_env(
                    self.sdk_configuration.security, models.Security
                ),
    ...
    async def libraries_cancel_sync_v1_async(
        self,
        *,
        library_id: str,
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
    ...
    def libraries_status_v1(
        ...
        *,
        ...
        timeout_ms: Optional[int] = None,
        http_headers: Optional[Mapping[str, str]] = None,
    ) -> models.LibraryStatusOut:
        r"""Get the status of a library.
        ...
        request = models.LibrariesStatusV1Request(
            library_id=library_id,
        )

        req = self._build_request(
            method="GET",
            path="/v1/libraries/{library_id}/status",
            base_url=base_url,
            url_variables=url_variables,
            request=request,
            request_body_required=False,
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(
                config=self.sdk_configuration,
                base_url=base_url or "",
                operation_id="libraries_status_v1",
                oauth2_scopes=None,
                security_source=get_security_from_env(
                    self.sdk_configuration.security, models.Security
                ),
        ...
        response_data: Any = None
        if utils.match_response(http_res, "200", "application/json"):
            return unmarshal_json_response(models.LibraryStatusOut, http_res)
        if utils.match_response(http_res, "422", "application/json"):
            response_data = unmarshal_json_response(
                errors.HTTPValidationErrorData, http_res
            )
    ...
    async def libraries_status_v1_async(
        self,
        *,
        library_id: str,
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
