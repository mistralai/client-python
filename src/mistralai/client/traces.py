...
class Traces(BaseSDK):
    def create_pipeline_config_v1_observability_pipeline_configs_post(
        ...
        *,
        ...
        selectors: Union[
            List[models.PipelineConfigSelector],
            List[models.PipelineConfigSelectorTypedDict],
        ],
        definition: Union[
    ...
    def aggregate(
        ...
        *,
        ...
        request = models.AggregateTracesV1ObservabilityTracesAggregatePostRequest(
            from_=from_,
            to=to,
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(
                config=self.sdk_configuration,
                base_url=base_url or "",
                operation_id="aggregate_traces_v1_observability_traces_aggregate_post",
                oauth2_scopes=None,
                security_source=get_security_from_env(
                    self.sdk_configuration.security, models.Security
                ),
