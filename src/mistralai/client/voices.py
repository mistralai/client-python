...
class Voices(BaseSDK):
    def list(
        ...
        *,
        ...
        request = models.ListVoicesV1VoicesGetRequest(
            limit=limit,
            offset=offset,
        )
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(
                ...
                operation_id="list_voices_v1_voices_get",
                oauth2_scopes=None,
        ...
        *,
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(
                config=self.sdk_configuration,
                base_url=base_url or "",
                operation_id="create_voice_v1_voices_post",
                oauth2_scopes=None,
                security_source=get_security_from_env(
                    self.sdk_configuration.security, models.Security
                ),
    ...
    def delete(
        ...
        *,
        ...
        request = models.DeleteVoiceV1VoicesVoiceIDDeleteRequest(
            voice_id=voice_id,
        )
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(
                config=self.sdk_configuration,
                base_url=base_url or "",
                operation_id="delete_voice_v1_voices__voice_id__delete",
                oauth2_scopes=None,
                security_source=get_security_from_env(
                    self.sdk_configuration.security, models.Security
                ),
    ...
    def update(
        ...
        *,
        ...
        request = models.UpdateVoiceV1VoicesVoiceIDPatchRequest(
            voice_id=voice_id,
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(
                config=self.sdk_configuration,
                base_url=base_url or "",
                operation_id="update_voice_v1_voices__voice_id__patch",
                oauth2_scopes=None,
                security_source=get_security_from_env(
                    self.sdk_configuration.security, models.Security
                ),
    ...
    def get(
        ...
        *,
        ...
        request = models.GetVoiceV1VoicesVoiceIDGetRequest(
            voice_id=voice_id,
        )
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(
                config=self.sdk_configuration,
                base_url=base_url or "",
                operation_id="get_voice_v1_voices__voice_id__get",
                oauth2_scopes=None,
                security_source=get_security_from_env(
                    self.sdk_configuration.security, models.Security
                ),
    ...
    def get_sample_audio(
        ...
        *,
        ...
        request = models.GetVoiceSampleAudioV1VoicesVoiceIDSampleGetRequest(
            voice_id=voice_id,
        )

        req = self._build_request(
            method="GET",
            path="/v1/voices/{voice_id}/sample",
            base_url=base_url,
            url_variables=url_variables,
            request=request,
            request_body_required=False,
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(
                config=self.sdk_configuration,
                base_url=base_url or "",
                operation_id="get_voice_sample_audio_v1_voices__voice_id__sample_get",
                oauth2_scopes=None,
                security_source=get_security_from_env(
                    self.sdk_configuration.security, models.Security
                ),
