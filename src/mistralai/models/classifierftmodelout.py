...
class ClassifierFTModelOutTypedDict(TypedDict):
    ...
    object: ClassifierFTModelOutObject
    name: NotRequired[Nullable[str]]
    description: NotRequired[Nullable[str]]
    max_context_length: NotRequired[int]
    aliases: NotRequired[List[str]]
    model_type: ClassifierFTModelOutModelType
...
class ClassifierFTModelOut(BaseModel):
    ...
    OBJECT: Annotated[
        Annotated[
            Optional[ClassifierFTModelOutObject],
            AfterValidator(validate_const("model")),
        ],
    ...
    MODEL_TYPE: Annotated[
        Annotated[
            Optional[ClassifierFTModelOutModelType],
