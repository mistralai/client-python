...
ConversationRestartStreamRequestToolsTypedDict = TypeAliasType(
...
ConversationRestartStreamRequestTools = Annotated[
    Union[
...
class ConversationRestartStreamRequestTypedDict(TypedDict):
    ...
    tools: NotRequired[List[ConversationRestartStreamRequestToolsTypedDict]]
...
class ConversationRestartStreamRequest(BaseModel):
    ...
    tools: Optional[List[ConversationRestartStreamRequestTools]] = None
    r"""List of tools which are available to the model during the conversation."""
