...
class ClassifierDetailedJobOutTypedDict(TypedDict):
    ...
    object: ClassifierDetailedJobOutObject
    ...
    job_type: ClassifierDetailedJobOutJobType
...
class ClassifierDetailedJobOut(BaseModel):
    ...
    OBJECT: Annotated[
        Annotated[
            Optional[ClassifierDetailedJobOutObject],
    ...
    JOB_TYPE: Annotated[
        Annotated[
            Optional[ClassifierDetailedJobOutJobType],
