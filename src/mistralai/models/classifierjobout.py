...
class ClassifierJobOutTypedDict(TypedDict):
    ...
    job_type: ClassifierJobOutJobType
    r"""The type of job (`FT` for fine-tuning)."""
...
class ClassifierJobOut(BaseModel):
    ...
    OBJECT: Annotated[
        Annotated[
            Optional[ClassifierJobOutObject], AfterValidator(validate_const("job"))
        ],
    ...
    JOB_TYPE: Annotated[
        Annotated[
            Optional[ClassifierJobOutJobType],
