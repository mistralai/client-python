...
with Mistral(
    ...
    res = mistral.events.receive_workflow_event_v1_workflows_events_post(event={
        "event_id": "<id>",
...
with Mistral(
    ...
    res = mistral.events.get_stream_events_v1_workflows_events_stream_get(scope="*", activity_name="*", activity_id="*", workflow_name="*", workflow_exec_id="*", root_workflow_exec_id="*", parent_workflow_exec_id="*", stream="*", start_seq=0)
...
with Mistral(
    ...
    res = mistral.events.get_workflow_events_v1_workflows_events_list_get(limit=100)
