...
<!-- UsageSnippet language="python" operationID="list_voices_v1_voices_get" method="get" path="/v1/voices" -->
```python
...
<!-- UsageSnippet language="python" operationID="create_voice_v1_voices_post" method="post" path="/v1/voices" -->
```python
from mistralai.client import Mistral
import os
...
<!-- UsageSnippet language="python" operationID="delete_voice_v1_voices__voice_id__delete" method="delete" path="/v1/voices/{voice_id}" -->
```python
from mistralai.client import Mistral
import os
...
with Mistral(
    ...
    res = mistral.audio.voices.delete(voice_id="63eaa3fb-0551-4dfc-8c1c-aa373b492248")
...
<!-- UsageSnippet language="python" operationID="update_voice_v1_voices__voice_id__patch" method="patch" path="/v1/voices/{voice_id}" -->
```python
from mistralai.client import Mistral
import os
...
with Mistral(
    ...
    res = mistral.audio.voices.update(voice_id="14e6277b-d297-431d-89bd-62661c8788e1")
...
<!-- UsageSnippet language="python" operationID="get_voice_v1_voices__voice_id__get" method="get" path="/v1/voices/{voice_id}" -->
```python
from mistralai.client import Mistral
import os
...
<!-- UsageSnippet language="python" operationID="get_voice_sample_audio_v1_voices__voice_id__sample_get" method="get" path="/v1/voices/{voice_id}/sample" -->
```python
from mistralai.client import Mistral
import os
...
**[str](../../models/responsegetvoicesampleaudiov1voicesvoiceidsampleget.md)**
