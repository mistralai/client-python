...
with Mistral(
    ...
    res = mistral.workflows.events.get_stream_events(scope=models.Scope.WILDCARD_, activity_name="*", activity_id="*", workflow_name="*", workflow_exec_id="*", root_workflow_exec_id="*", parent_workflow_exec_id="*", stream="*", start_seq=0)
