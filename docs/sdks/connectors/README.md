...
| `protocol`                                                                                          | [OptionalNullable[models.ConnectorProtocol]](../../models/connectorprotocol.md)                     | :heavy_minus_sign:                                                                                  | Protocol of the connector.                                                                          |
...
with Mistral(
    ...
    res = mistral.beta.connectors.get(connector_id_or_name="<value>", fetch_customer_data=False)
