...
(beta) Explore past chat completion events
...
**[models.ChatCompletionEvents](../../models/chatcompletionevents.md)**
...
**[models.ChatCompletionEventIds](../../models/chatcompletioneventids.md)**
...
| ------------------------------------------------------------------- | ------------------------------------------------------------------- | ------------------------------------------------------------------- | ------------------------------------------------------------------- |
| `event_id`                                                          | *str*                                                               | :heavy_check_mark:                                                  | N/A                                                                 |
| `judge_definition`                                                  | [models.PostJudgeInSchema](../../models/postjudgeinschema.md)       | :heavy_check_mark:                                                  | N/A                                                                 |
| `retries`                                                           | [Optional[utils.RetryConfig]](../../models/utils/retryconfig.md)    | :heavy_minus_sign:                                                  | Configuration to override the default retry behavior of the client. |
