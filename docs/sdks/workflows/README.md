...
* [execute_workflow_registration](#execute_workflow_registration) - Execute Workflow Registration
...
with Mistral(
    ...
    res = mistral.workflows.get_workflows(active_only=False, include_shared=True, include_archived=False)
...
with Mistral(
    ...
    res = mistral.workflows.get_workflow_registrations(active_only=False, include_shared=True, include_archived=False, with_workflow=False)
