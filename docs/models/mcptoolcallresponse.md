...
| ---------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------- |
| `content`                                                                          | List[[models.MCPToolCallResponseContent](../models/mcptoolcallresponsecontent.md)] | :heavy_check_mark:                                                                 | N/A                                                                                |
| `metadata`                                                                         | [OptionalNullable[models.MCPToolCallMetadata]](../models/mcptoolcallmetadata.md)   | :heavy_minus_sign:                                                                 | N/A                                                                                |
