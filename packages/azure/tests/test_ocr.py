...
def test_ocr_ocr_v1_ocr_post():
    test_http_client = create_test_http_client("ocr_v1_ocr_post")
    ...
    with MistralAzure(
        ...
        assert res == models.OCRResponse(
            pages=[],
            model="Golf",
            usage_info=models.OCRUsageInfo(
                pages_processed=944919,
            ),
        )


def test_ocr_ocr_v1_ocr_post_user_example():
    test_http_client = create_test_http_client("ocr_v1_ocr_post-userExample")
        ...
        assert res == models.OCRResponse(
            pages=[
                models.OCRPageObject(
                    ...
                    images=[],
                    dimensions=models.OCRPageDimensions(
                        dpi=200,
                        height=2200,
                        width=1700,
                    ),
